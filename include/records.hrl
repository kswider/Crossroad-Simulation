...
-record(world_parameters,{world_width, world_height, main_light_time,sub_light_time,yellow_light_time,cars_start_amount,pedestrian_start_amount,pedestrian_speed}).
